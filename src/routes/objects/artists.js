...
const calculateURLSArtist = (currentURL, artistId) => {
  let albumsURL = `https://${currentURL}/artists/${artistId}/albums`
  let tracksURL = `https://${currentURL}/artists/${artistId}/tracks`
  let selfURL = `https://${currentURL}/artists/${artistId}`
